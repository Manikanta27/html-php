...
if (isset($_POST['payment'])) {	
 ...
 $query= "INSERT INTO `transaction` (`user_id`,`amount`) VALUES ('$id','$price')";
 //echo $query;
 ...
 // check amount validation and field validations
 }
 ?>
...
<div class="container">
  <div id="Checkout" class="inline">
      ...
      <form action="#" method="POST">
          ...
          <button id="PayButton" class="btn btn-block btn-success submit-button" type="submit" name="payment">
              <span class="submit-button-lock"></span>
              <span class="align-middle"> <?php echo $price ?> </span>
          </button>
      </form>
  </div>
</div>
